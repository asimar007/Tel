...
const DateTime: React.FC = () => {
  ...
  return (
    <motion.div
      className="border border-blue-500 rounded-sm p-1 from-blue-900/30 to-blue-950/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] group"
